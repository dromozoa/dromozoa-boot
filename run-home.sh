...
# Copyright (C) 2018,2020,2021,2023-2026 Tomoyuki Fujimori <moyu@dromozoa.com>
#
...
./dromozoa-boot --prefix="$HOME/prefixes/dromozoa" m4 autoconf automake libtool bison screen tig libsodium zeromq libjpeg libpng hook
...
./dromozoa-boot --prefix="$HOME/prefixes/dromozoa55" lua55 luarocks vim
